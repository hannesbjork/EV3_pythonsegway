...
while loop:
   ...
   # print(accel, " ", accelSensor.value(n=2)/(pow(10,accelSensor.decimals)))
    ...
    angle = (0.95)*(angle- angularSpeed*dt) + (0.05)*(accel-2.75)   # Komplementär filter. Notera viktningen
   ...
   # u = ( 0.0004  *wheelangle  +0.0378*wheelSpeed  -400.4293  *angle + 15.4029*angularSpeed)/360*2*3.14
    u = (0.0010*wheelangle  +0.0476 *wheelSpeed -254.3399*angle + 12.5356*angularSpeed)/360*2*3.14
